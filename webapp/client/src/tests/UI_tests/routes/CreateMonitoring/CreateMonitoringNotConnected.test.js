...
/////////////////////////////////////////// NEEDS TO BE REWRITTEN AFTER FIXING NOT CONNECTED ACCESSING PAGE //////////////////////////
...
describe('/probe/1/monitoring/0 route not connected', () => {
  it('checks an error message is rendered : not connected', async () => {
