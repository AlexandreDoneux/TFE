...
///////NEEDS TO BE REWRITEN AFTER FIXING DIFFERENT USER CAN ACCESS DATA FROM DIFFERENT USER////////
...
describe('/probe/1/monitoring/1 route connected', () => {
  it('checks the MenuDrawer component, the Chart component and the archive monitoring button are rendered.', async () => {
