...
const ArchivedList = () => {
  ...
  useEffect(() => {
    ...
    axios.post(`https://www.alexandre.doneux.eu:8443/monitoring/get_archived`,
        { 
        // nothing -> remove
            "test" : "test"
        },
        ...
        .then((response) => {
          ...
          const requests = archived_monitoring_ids.map((id) => axios.post(`https://www.alexandre.doneux.eu:8443/monitoring/get_data`,
              { 
                  "monitor_id" : id
              },
              {
